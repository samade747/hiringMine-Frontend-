          ...
          <Grid container rowSpacing={3} columnSpacing={{ xs: 1, sm: 2, md: 3 }} marginTop={"20px"}>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <div className="footerRight">
                ...
                <p className="footerRightPara1">
                  HiringMine connects employer and job seekers, where employers are the source of the resources and the job seeker can find and apply for their targeted job.
                </p>
              </div>
              {/* Follow us section */}
              <p className="footerRightPara">Follow us</p>
              {/* Social media icons */}
              <div className="footerRightIocns">
                <img src="https://hiringmine.com/assets/FacebookIcon-d00bcd86.svg" alt="Facebook" />
                <img src="https://hiringmine.com/assets/WhatsAppIcon-21b9cb15.svg" alt="WhatsApp" />
                <img src="https://hiringmine.com/assets/IstagramIcon-cd882890.svg" alt="Instagram" />
                <img src="https://hiringmine.com/assets/LinkedinIcon-95a0c942.svg" alt="LinkedIn" />
              </div>
            </Grid>
            ...
            <Grid item xs={12} sm={12} md={8} lg={8}>
              <div className="footerLeftInfoPar">
                <div className="footerLeftInfo">
                  ...
                  <a href="mailto:portal.hiringmine@gmail.com">
                    <EmailOutlinedIcon />portal.hiringmine@gmail.com
                  </a>
                </div>
              </div>
            </Grid>
