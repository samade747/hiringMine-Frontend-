...
function Header() {
  ...
  // Retrieve theme and keyword states from Redux store
  ...
  // Handler function for searching jobs
      ...
      <Box sx={{ width: '100%', maxWidth: 700 }}>
        ...
        <Box className="searchBarPar">
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Search by Role or Keyword"
                style={{ border: bgTheme && "2px solid #1b1b1b ", borderRadius: bgTheme && "5px" }}
                InputProps={{
                  ...params.InputProps,
                  style: {
